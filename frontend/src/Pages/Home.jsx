...
import { Station,Trains } from '../Utilities/trainData';
...
const Home = () => {
  ...
  const handleLogout = () => {
    ...
    try{
      const response= await axiosInstance.post("/api/search-trains",{
        startStation,
        endStation,
        selectedDate,
      });
    ...
    const columns = [
      ...
      { field: 'name', headerName: 'Train Name', width: 150 },
