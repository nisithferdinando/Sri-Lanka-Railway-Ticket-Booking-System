        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2 bg-white shadow-md rounded-lg p-6">
            ...
            <div className="space-y-3 mb-6">
              <p>
                <span className="font-semibold text-sm">දුම්රිය:</span>{" "}
                {bookingDetails.trainDetails.trainName}
              </p>
              <p>
                <span className="font-semibold text-sm">මැදිරිය:</span>{" "}
                {bookingDetails.compartment}
              </p>
              <p>
                <span className="font-semibold text-sm">ආසන අංක:</span>{" "}
                {bookingDetails.selectedSeats.join(", ")}
              </p>
              <p>
                <span className="font-semibold text-sm">ගමන් දිනය:</span>{" "}
                {bookingDetails.selectedDate}
              </p>
              <p>
                <span className="font-semibold text-sm">අනවුම් දිනය:</span>{" "}
                {bookingDate}
              </p>
              <p>
